...
export default function CreateAddress() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('addresses.store')); // matches controller route
    };
                ...
                <main className="max-w-4xl mx-auto px-6 py-12">
                    <section className="bg-white rounded-xl shadow p-8 space-y-10">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-8">
                            ...
                            {/* Address Type */}
                            <div>
                                <label className="block text-sm font-medium text-[#4B3B2A] mb-1">Address Type</label>
                                <select
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                />
                                <span className="text-sm text-[#4B3B2A]">Set as default address</span>
                            </div>
