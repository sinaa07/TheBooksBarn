...
export default function Dashboard({ user, addresses=[],totalAddresses}: Props) {
    const { post } = useForm();
                    ...
                    <section className="bg-white rounded-xl shadow p-8 space-y-10">
                        <div>
                            <div className="flex justify-between items-center mb-6">
                                <h2 className="text-2xl font-semibold text-[#4B3B2A] font-serif">
                                     Profile Information
                                </h2>
                                <a
                        ...
                        {/* Use the new AddressPreview component */}
                        <AddressPreview addresses={addresses} totalAddresses={totalAddresses}/>
                    </section>
                </main>
